...
if st.button("Calcular"):
    if lucro_desejado > 0 and odd_back > 1 and odd_lay > 1:
        # Calcular a Stake para odd Back
        stake_back = lucro_desejado / (odd_back - 1)
        ...
        st.write(f"- Apostando em uma odd Back de {odd_back:.2f}, você deve apostar R$ {stake_back:.2f}.")
